...
@section('body')
    ...
    <section class="py-16 bg-white relative -mt-16 z-30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 hover:-translate-y-2 transition duration-300">
                    <div class="w-14 h-14 rounded-xl bg-blue-50 text-primary flex items-center justify-center text-2xl mb-6">
                        <i class="fas fa-user-md"></i>
                    </div>
                    <h3 class="text-xl font-bold text-slate-800 mb-3">Đội ngũ chuyên gia</h3>
                    <p class="text-slate-500 leading-relaxed">Hơn 200 bác sĩ đầu ngành từ các bệnh viện lớn, giàu kinh nghiệm và tận tâm.</p>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 hover:-translate-y-2 transition duration-300">
                    <div class="w-14 h-14 rounded-xl bg-green-50 text-green-600 flex items-center justify-center text-2xl mb-6">
                        <i class="fas fa-file-medical-alt"></i>
                    </div>
                    <h3 class="text-xl font-bold text-slate-800 mb-3">Hồ sơ số hóa</h3>
                    <p class="text-slate-500 leading-relaxed">Lưu trữ bệnh án, kết quả xét nghiệm và đơn thuốc trọn đời, bảo mật tuyệt đối.</p>
                </div>
                <div class="bg-white p-8 rounded-2xl shadow-xl border border-slate-100 hover:-translate-y-2 transition duration-300">
                    <div class="w-14 h-14 rounded-xl bg-purple-50 text-purple-600 flex items-center justify-center text-2xl mb-6">
                        <i class="fas fa-laptop-medical"></i>
                    </div>
                    <h3 class="text-xl font-bold text-slate-800 mb-3">Tư vấn từ xa</h3>
                    <p class="text-slate-500 leading-relaxed">Kết nối Video Call trực tiếp với bác sĩ, nhận tư vấn sức khỏe mà không cần đi xa.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-primary font-bold tracking-wider uppercase text-sm">Quy trình đơn giản</span>
                <h2 class="text-3xl lg:text-4xl font-extrabold text-slate-800 mt-2">Trải nghiệm khám bệnh thông minh</h2>
            </div>
            ...
            <div class="relative">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative z-10">
                    <div class="text-center group">
                        <div class="w-20 h-20 mx-auto bg-white border-4 border-white shadow-lg rounded-full flex items-center justify-center text-2xl text-slate-400 group-hover:text-white group-hover:bg-primary transition duration-300 mb-6 relative">
                            <i class="fas fa-calendar-alt"></i>
                            <span class="absolute -top-2 -right-2 w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center font-bold text-sm border-2 border-white">1</span>
                        </div>
                        <h4 class="text-lg font-bold text-slate-800 mb-2">Đặt lịch online</h4>
                        <p class="text-sm text-slate-500 px-4">Chọn chuyên khoa, bác sĩ và giờ khám phù hợp.</p>
                    </div>
                    <div class="text-center group">
                        <div class="w-20 h-20 mx-auto bg-white border-4 border-white shadow-lg rounded-full flex items-center justify-center text-2xl text-slate-400 group-hover:text-white group-hover:bg-primary transition duration-300 mb-6 relative">
                            <i class="fas fa-user-md"></i>
                            <span class="absolute -top-2 -right-2 w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center font-bold text-sm border-2 border-white">2</span>
                        </div>
                        <h4 class="text-lg font-bold text-slate-800 mb-2">Khám tư vấn</h4>
                        <p class="text-sm text-slate-500 px-4">Gặp bác sĩ tại phòng khám hoặc qua Video Call.</p>
                    </div>
                    <div class="text-center group">
                        <div class="w-20 h-20 mx-auto bg-white border-4 border-white shadow-lg rounded-full flex items-center justify-center text-2xl text-slate-400 group-hover:text-white group-hover:bg-primary transition duration-300 mb-6 relative">
                            <i class="fas fa-file-upload"></i>
                            <span class="absolute -top-2 -right-2 w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center font-bold text-sm border-2 border-white">3</span>
                        </div>
                        <h4 class="text-lg font-bold text-slate-800 mb-2">Cận lâm sàng</h4>
                        <p class="text-sm text-slate-500 px-4">Thực hiện xét nghiệm và tải kết quả lên hệ thống.</p>
                    </div>
                    <div class="text-center group">
                        <div class="w-20 h-20 mx-auto bg-white border-4 border-white shadow-lg rounded-full flex items-center justify-center text-2xl text-slate-400 group-hover:text-white group-hover:bg-primary transition duration-300 mb-6 relative">
                            <i class="fas fa-file-prescription"></i>
                            <span class="absolute -top-2 -right-2 w-8 h-8 bg-primary text-white rounded-full flex items-center justify-center font-bold text-sm border-2 border-white">4</span>
                        </div>
                        <h4 class="text-lg font-bold text-slate-800 mb-2">Nhận kết quả</h4>
                        <p class="text-sm text-slate-500 px-4">Nhận chẩn đoán, đơn thuốc điện tử và hóa đơn.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- 4. [MỚI] BÁC SĨ TIÊU BIỂU --}}
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-end mb-12">
                <div>
                    <h2 class="text-3xl font-extrabold text-slate-800 mb-2">Bác sĩ tiêu biểu</h2>
                    <p class="text-slate-500">Được bệnh nhân tin tưởng và đánh giá cao nhất.</p>
                </div>
                <a href="{{ route('schedule') }}" class="hidden md:flex items-center text-primary font-bold hover:underline">
                    Xem tất cả bác sĩ <i class="fas fa-arrow-right ml-2"></i>
                </a>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach($featuredDoctors as $doctor)
                    <div class="group bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all duration-300 relative overflow-hidden">
                        {{-- Background Decor --}}
                        <div class="absolute top-0 left-0 w-full h-24 bg-gradient-to-br from-blue-50 to-slate-50"></div>
                        
                        <div class="p-6 pt-8 text-center relative z-10">
                            <div class="relative inline-block mx-auto mb-4">
                                <img src="{{ $doctor->image ? asset('storage/'.$doctor->image) : 'https://ui-avatars.com/api/?name='.urlencode($doctor->user->name).'&size=128' }}" 
                                     class="w-28 h-28 rounded-full object-cover border-4 border-white shadow-md group-hover:scale-105 transition duration-300"
                                     alt="{{ $doctor->user->name }}">
                                @if($doctor->license_number)
                                    <div class="absolute bottom-1 right-1 bg-green-500 text-white text-[10px] p-1 rounded-full border-2 border-white shadow-sm" title="Đã xác thực">
                                        <i class="fas fa-check"></i>
                                    </div>
                                @endif
                            </div>
                            
                            <h3 class="text-lg font-bold text-slate-800 mb-1 group-hover:text-primary transition">
                                <a href="{{ route('site.doctors.show', $doctor->id) }}">
                                    @if($doctor->degree) <span class="text-sm font-normal text-slate-500">{{ $doctor->degree }}</span> @endif 
                                    {{ $doctor->user->name }}
                                </a>
                            </h3>
                            <p class="text-sm text-primary font-medium mb-3">{{ $doctor->department->name }}</p>
                            
                            <div class="flex justify-center items-center gap-1 text-yellow-400 text-sm mb-4">
                                <span class="font-bold text-slate-700 mr-1">{{ number_format($doctor->rating, 1) }}</span>
                                <i class="fas fa-star"></i>
                                <span class="text-xs text-slate-400 ml-1">({{ $doctor->reviews_count }} đánh giá)</span>
                            </div>

                            <a href="{{ route('schedule', ['doctor_id' => $doctor->id]) }}" class="inline-flex items-center justify-center w-full py-2.5 bg-slate-50 text-slate-600 font-bold rounded-lg group-hover:bg-primary group-hover:text-white transition-colors">
                                Đặt lịch khám
                            </a>
                        </div>
                    </div>
