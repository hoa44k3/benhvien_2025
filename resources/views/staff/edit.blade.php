    ...
    <div class="card shadow-lg border-0 rounded-3">
        <div class="card-header bg-warning text-dark py-3">
            <h4 class="mb-0 fw-bold">
                <i class="fas fa-user-edit me-2"></i> Chỉnh sửa Hồ sơ: {{ $staff->name }}
            </h4>
        </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="staff_code" id="staffCode" class="form-control" 
                        ...
                        <div class="input-group">
                            ...
                            <select name="department_id" id="departmentId" class="form-select">
                                ...
                                @foreach($departments as $dep)
                                    <option value="{{ $dep->id }}" 
                                            @selected(old('department_id', $staff->department_id) == $dep->id)>
                                        {{ $dep->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <select name="role_id" id="roleId" class="form-select">
                                ...
                                @foreach($roles as $role)
                                    <option value="{{ $role->id }}" 
                                            @selected(old('role_id', $staff->role_id) == $role->id)>
                                        {{ $role->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="experience_years" id="experienceYears" class="form-control" 
                                   value="{{ old('experience_years', $staff->experience_years) }}" min="0">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.1" min="0" max="5" name="rating" id="rating" class="form-control" 
                                   value="{{ old('rating', $staff->rating) }}">
                        </div>
                    </div>
                </div>

                <div class="mt-4 pt-3 border-top text-end">
                    <a href="{{ route('staff.index') }}" class="btn btn-outline-secondary me-2">
                        <i class="fas fa-arrow-left me-1"></i> Quay lại
                    </a>
                    <button type="submit" class="btn btn-warning shadow-sm text-dark fw-bold">
                        <i class="fas fa-sync-alt me-1"></i> Cập nhật Hồ sơ
                    </button>
                </div>
            </form>
        </div>
